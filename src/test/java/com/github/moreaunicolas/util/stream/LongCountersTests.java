...
public class LongCountersTests {
    ...
    public void countReturnsNumberOfSatisfyingElement() {
        ...
        assertThat(countMultiplesOf4.in(LongStream.of(NUMBERS).iterator())).isEqualTo(2);
    }
    ...
    public void countReturnsZeroWhenThereAreNoSatisfyingElements() {
        ...
        assertThat(countNegatives.in(LongStream.of(NUMBERS).iterator())).isEqualTo(0);
    }

    @Test
    public void isUtilityClass() throws NoSuchMethodException {
        UtilityClassAssert.assertThat(LongCounters.class)
                .isUtilityClass();
    }
}
