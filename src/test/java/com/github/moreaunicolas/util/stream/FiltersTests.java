...
public class FiltersTests {
    ...
    public void findAllReturnsSatisfyingElements() {
        ...
        assertThat(findAllVowels.in(Enumerations.forArray(LETTERS))).contains("a", "e");
    }
    ...
    public void findAllReturnsEmptyWhenThereAreNoSatisfyingElements() {
        ...
        assertThat(findAllEqualToZ.in(Enumerations.forArray(LETTERS))).isEmpty();
    }
    ...
    public void findFirstReturnsTheFirstSatisfyingElement() {
        ...
        assertThat(findFirstVowel.in(Enumerations.forArray(LETTERS))).contains("a");
    }
    ...
    public void findFirstReturnsEmptyWhenThereAreNoSatisfyingElements() {
        ...
        assertThat(findFirstEqualToZ.in(Enumerations.forArray(LETTERS))).isEmpty();
    }
    ...
    public void findAnyReturnsAnySatisfyingElement() {
        ...
        assertThat(findAnyVowel.in(Enumerations.forArray(LETTERS)).get()).isIn("a", "e");
    }
    ...
    public void findAnyReturnsEmptyWhenThereAreNoSatisfyingElements() {
        ...
        assertThat(findAnyEqualToZ.in(Enumerations.forArray(LETTERS))).isEmpty();
    }
    ...
    public void minReturnsMinimumElement() {
        ...
        assertThat(min.in(Enumerations.forArray(LETTERS))).contains("a");
    }
